	...
	<div id="container">
		<div id="hd">
			...
			<div>
				<nav id="nav">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<form class="fudong" action="<%=basePath%>user/user-index0_3"
						method="get">
			...
			<div class="wrap ue-clear">
				<div class="sidebar">
					...
					<ul class="nav">
						...
						<li class="konwledge">
							<div class="nav-header">
								<a href="<%=basePath%>javascript:;" class="ue-clear"><span>查看负责项目</span><i
									class="icon"></i></a>
							</div>
							<ul class="subnav">
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>/project2/project2_dmlook?id=<s:property value="user.id"/>">项目查看</a></li>
							</ul>
						</li>
						<li class="konwledge">
							<div class="nav-header">
							...
							<ul class="subnav">
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>watch/watch_unallocated?user.id=<s:property value="user.id"/>">未分配验收点</a></li>
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>watch/watch_unfinishByDept?user.id=<s:property value="user.id"/>">未完成验收点</a></li>
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>watch/watch_unpend?user.id=<s:property value="user.id"/>">待审核验收点</a></li>
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>watch/watch_finishByDept?user.id=<s:property value="user.id"/>">已审核的验收点</a></li>
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>watch/watch_finishByDept2?user.id=<s:property value="user.id"/>">已验收的验收点</a></li>
							</ul>
						</li>
					</ul>
				</div>
