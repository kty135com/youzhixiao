...
<title>辅助的验收要点未分配列表</title>
</head>

<body>
<div class="title"><h2>辅助的验收要点未分配列表</h2></div>
<div class="query">
<div class="table-box">
	<table>
    	<thead>
           ...
           <s:iterator value="watchs" var="w" status="status">
        	<tr>
                ...
                <a href="<%=basePath%>watch/watch_otherAllocate1?watch.id=<s:property value="#w.id"/>&user.id=<s:property value="user.id"/>"class="edit">分配</a>         
                </td>
            </tr>
            </s:iterator>       
    </table>
