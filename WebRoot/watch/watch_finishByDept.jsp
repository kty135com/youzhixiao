...
<title>已完成验收要点列表</title>
</head>

<body>
<div class="title"><h2>已完成验收要点列表</h2></div>
<div class="query">
<div class="table-box">
<form action="<%=basePath%>watch/watch_queryFinishByDept" method="post">
        <label>三级项目名称：</label>
    	...
    	<thead>
           ...
           <s:iterator value="watchs" var="w" status="status">
        	<tr>
                ...
                <td ><s:if test="#w.state==2">审核通过</s:if><s:if test="#w.state==4">验收通过</s:if><s:if test="#w.state==5">超管通过</s:if></td> 
