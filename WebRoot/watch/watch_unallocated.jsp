...
<title>未分配验收要点列表</title>
</head>

<body>
<div class="title"><h2>未分配验收要点列表</h2></div>
<div class="query">
<div class="table-box">
<form action="<%=basePath%>watch/watch_queryUnAllocated" method="post">
        <label>三级项目名称：</label>
    	...
    	<thead>
           ...
           <s:iterator value="watchs" var="w" status="status">
        	<tr>
                ...
                <a href="<%=basePath%>watch/watch_allocate1?watch.id=<s:property value="#w.id"/>&user.id=<s:property value="user.id"/>"class="edit">分配</a>         
                </td>
            </tr>
            </s:iterator>       
    </table>
