...
<title>完成验收要点列表</title>
</head>

<body>
<div class="title"><h2>完成验收要点列表</h2></div>
<div class="query">
<div class="table-box">
	<table>
    	<thead>
           ...
           <s:iterator value="watchs" var="w" status="status">
        	<tr>
                ...
                <a href="<%=basePath%>watch/watch_update1?watch.id=<s:property value="#w.id"/>"class="edit">修改</a>
                <a href="<%=basePath%>watch/watch_delete?watch.id=<s:property value="#w.id"/>"class="del">删除</a>             
                </td>
            </tr>
            </s:iterator>       
    </table>
