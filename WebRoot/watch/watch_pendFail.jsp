				...
				<s:iterator value="watchs" var="w" status="status">
					<tr>
						...
						<td class="table-operate ue-clear"><a
							href="<%=basePath%>watch/watch_failShow?watch.id=<s:property value="#w.id"/>"
							class="add">查看</a> <a
							href="<%=basePath%>file/file_add1?watch.id=<s:property value="#w.id"/>&user.id=${user.id}"
							class="edit">上传</a> <a
