			...
			<div>
				<nav id="nav">
					<form class="fudong" action="<%=basePath%>user/user-index0_2"
						method="get">
						<input type="hidden" value="2" name="urlNo"> <input type="hidden" value="${user.id }" name="user.id"><input
							type="image" src="<%=basePath%>images/button2.png" alt="各级项目进展"
							width="122" height="29" />
					</form>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<form class="fudong" action="<%=basePath%>user/user-index0_2">
						<input type="hidden" value="3" name="urlNo"><input type="hidden" value="${user.id }" name="user.id"> <input
							type="image" src="<%=basePath%>images/button3.png" alt="成果展示"
							width="122" height="29" />
					</form class="fudong">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<form class="fudong" action="<%=basePath%>user/user-index0_2">
						<input type="hidden" value="5" name="urlNo"> <input type="hidden" value="${user.id }" name="user.id"><input
				...
				<div class="sidebar">
					...
					<ul class="nav">
						...
						<li class="konwledge">
							...
							<ul class="subnav">
								<li><a href="<%=basePath%>javascript:;"
									date-src="<%=basePath%>project2/project2_pendBypro1admin?project2.pro1_id=${project1.id}">审核项目</a></li>
							</ul>
						</li>
					</ul>
				</div>
