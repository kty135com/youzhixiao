				...
				<s:iterator value="list" var="p1" status="p1t">
					<tr>
						...
						<td><s:if test="#p1.state==0">建设中</s:if> <s:if
								test="#p1.state==1">已完成</s:if>
						</td>
						<td class="table-operate ue-clear"><a
							href="<%=basePath%>project1/project1_lookup2?id=<s:property value="#p1.id"/>"
							class="add">查看</a><a
							href="<%=basePath%>project1/project1_shenhe2?id=<s:property value="#p1.id"/>"
							class="edit">退回</a>
						</td>
					</tr>
				</s:iterator>
